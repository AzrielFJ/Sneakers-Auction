...
public class EditPassword extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        editTextUsername = view.findViewById(R.id.et_password);
    ...
    public void editpassword(){
        mApiService.editPassword(sharedPreference.getSpUserId(),editTextUsername.getText().toString(),editPassword2.getText().toString()).
                    ...
                    public void onResponse(Call<ListPetugasResponse> call, Response<ListPetugasResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body().getStatus().equals(true)) {
                                Toast.makeText(mContext, "Edit Password was Successfully ", Toast.LENGTH_SHORT).show();


                            }else {
                                Toast.makeText(mContext, "Your Old Password is Wrong", Toast.LENGTH_SHORT).show();
 ...
 if(editTextUsername.getText().toString().isEmpty() || editPassword2.getText().toString().isEmpty()) {
